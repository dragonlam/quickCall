...
import com.quickcall.dao.UserDao;
import com.quickcall.model.PageBean;
import com.quickcall.model.User;
import com.quickcall.util.DbUtil;
import com.quickcall.util.ExcelUtil;
import com.quickcall.util.JsonUtil;
import com.quickcall.util.ResponseUtil;
...
public class UserAction extends ActionSupport {
	...
	public String export2()throws Exception{
		...
		try {
			...
			ResponseUtil.export(ServletActionContext.getResponse(), wb, "匹配后的推荐方案.xls");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}finally{
